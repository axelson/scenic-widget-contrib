# defmodule QuillEx.GUI.Components.EditorTwo do
...
#       fn graph ->
#         p_text = QuillEx.GUI.Components.PlainText.new(%{text: "Vaporwave!!!"})

#         graph
#         |> render_background(state, frame)
#         |> QuillEx.GUI.Components.PlainText.add_to_graph({p_text, frame})
#       end,
#       id: __MODULE__,
